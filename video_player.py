...
@@ -66,20 +150,53 @@ def add_to_playlist(self, playlist_name, video_id):
            playlist_name: The playlist name.
    ...
    def show_playlist(self, playlist_name):
        ...
        if name in self.playlists:
            ...
            print("Showing playlist:", playlist_name,
                  f"({len(playlist.videos)}) video{''.join(['s' for _ in range(1) if len(playlist.videos) > 1])}")
...
@@ -88,39 +205,102 @@ def remove_from_playlist(self, playlist_name, video_id):
            playlist_name: The playlist name.
...
@@ -129,12 +309,33 @@ def flag_video(self, video_id, flag_reason=""):
